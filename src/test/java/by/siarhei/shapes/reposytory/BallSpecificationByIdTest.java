...
import by.siarhei.shapes.repository.impl.BallSpecificationById;
...
public class BallSpecificationByIdTest {
    private BallSpecificationById byId;
    ...
    void setUp() {
        ...
        byId = new BallSpecificationById(101L);
    ...
    @Test
    void queryByIdTest() {
        List<Ball> actualList = BallRepository.getInstance().query(byId);
